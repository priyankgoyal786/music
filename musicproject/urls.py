...
urlpatterns = [
    ...
    # url(r'^music/$', views.MusicTrackDetails.as_view(), name='addmusic'),
    # url(r'^editmusic/(?P<id>\d+)/$', login_required(views.EditMusicTrackDetails.as_view(), login_url="/")  , name='editmusic'),
    # url(r'^music_show/$', login_required(views.show_MusicTrack_Details(), login_url="/"), name='music_show'),

    url(r'^musicshow/$', views.MusicTrackDetails, name='music_show'),
    ...
    url(r'^genresshow/$', views.GenresDetails, name='genres_show'),
